...
export default function UserDashboard() {
    return (
        <>
            ...
            <div className='mt-[29px] flex flex-col gap-y-[29px] text-sm'>
                <div className='flex justify-between items-center'>
                    <span className='font-medium text-xs'>Apply For Resit</span>
                    <span className='font-medium text-xs'>Resit Dates</span>
                </div>

                <div className='grid grid-cols-2 gap-x-4'>

                    <div className='bg-white h-60 rounded-xl p-6 flex flex-col justify-center items-center gap-y-6'>
                        ...
                        <button className='bg-[#e4cffe] cursor-pointer text-[#821adb] px-4 py-2 rounded-full text-xs font-semibold'>
                            Apply Resit
                        </button>
                    </div>

                    <div className='bg-white h-60 rounded-xl p-6'>
                        <div className='w-full'>
                            ...
                            <div className='flex justify-between items-center text-sm'>
                                <span
                                    className='bg-[#e4cffe] text-[#821adb] px-2 py-1 rounded-full text-xs'>MATH 101</span>
                                <span>07.07.2025</span>
                                <button
                                    className='bg-[#d4e9d2] text-[#469d61] px-3 py-1 rounded-full text-xs font-medium'>
                                    Show Resit
                                </button>
                            </div>
                        </div>
